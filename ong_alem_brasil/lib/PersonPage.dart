  ...
  Widget build(BuildContext context) {
    return Padding(
      ...
      child: Column(
        ...
        children: <Widget>[
          Center(
            child: Text("Pessoas", style: TextStyle(color: Colors.green, fontSize: 30),),
          ),
          SizedBox(height: 10,),
          Center(
            child: Text("Cadastro e Consulta de Pessoas", style: TextStyle(color: Colors.green, fontSize: 16),),
          )
        ],
      ),
    );
  ...
  Widget build(BuildContext context) {
    return Padding(
      ...
      child: Column(
          ...
          Row(
            ...
            children: [
              ...
              Container(
                ...
                child: Column(
                  children: [
                    Icon(Icons.add_location_outlined, size: 70, color: Colors.white,),
                    Text("Endereços Cadastrados", style: TextStyle(color: Colors.white, fontSize: 13),),
                    Text("Total: 4", style: TextStyle(color: Colors.white, fontSize: 16),),
                  ],
                ),
              ),
          ...
          Container(
            padding: EdgeInsets.fromLTRB(0, 20, 0, 10),
              child: ElevatedButton(
                ...
                onPressed: () {
                  Navigator.of(context).pushNamed('/registerPerson');
                },
        ...
        onPressed: () {
          Navigator.of(context).pushNamed('/querryPerson');
        },
